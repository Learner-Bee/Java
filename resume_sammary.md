...
* 原理 ： 
  1、分别拿第i个元素与所有元素比较，所有大于其的元素进行位置交换。逐渐将小的数字放在前面，大的数字放在后面
###插入排序

* 时间复杂度n^2  
* 原理：将序列第一个数作为一个有序序列，然后从第二个数开始逐个插入中。直至整个序列排序完成
###选择排序
###二分查找
###归并
##2、一定需要捕获的异常有哪些
...
1、java机制，当hashcode不等时，不会比较equals方法  ； 当hashcode相等时，还会比较equals方法  
